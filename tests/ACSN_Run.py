...
I = io.imread('Python Test Images/TIRF_01_10ms.tif')
color = False
...
Qscore, sigma, img, SaveFileName = ACSN.ACSN(I,NA,Lambda,PixelSize,varargin)
...
directory_out = "tests/results/"

io.imsave(directory_out + SaveFileName, img_save)

# Save floating point matrix created from ACSN function - not transposed
directory_arr = "results/"
pickle.dump(img, open( directory_out + "floating_point_matrix_" + SaveFileName + ".pckl", "wb" ) )
